  ...
  return (
    <>
      <div className='flex flex-col text-lg sm:text-base'>
        ...
        <input onInput={showWarningHandler} onBlur={showWarningHandler} ref={inputRef} type={type} id={idHtmlFor} name={name} className={`outline-none border rounded-md p-2.5 ${isWarningVisible ? "border-red-500" : "border-gray-400"}`} />
        {isWarningVisible &&
